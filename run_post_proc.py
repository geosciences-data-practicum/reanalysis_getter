...
#	if model in ['MRI-ESM2-0_hist_tas_daily','GFDL-ESM4_ssp585_tas_daily','CESM2-WACCM_ssp585_tas_daily','UKESM1-0-LL_ssp585_tas_daily','MPI-ESM1-2-HR_ssp585_tas_daily']: 
#		continue
	...
	single = SingleModelPostProcessor(path_to_files=path_processed,
                 path_to_save_files=path_postproc+shortname,
